...
class _POCConfig(BaseSettings):
    """Define config specific to the this particular connector."""
    ...
    tlp_level: Literal[
        ...
        description="TLP level to apply to OpenCTI entities.",
        default="amber",
    )
...
class ConnectorConfig(BaseSettings):
    ...
    - poc: The config specific to the finale connector.
    """
