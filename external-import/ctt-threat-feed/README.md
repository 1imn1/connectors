...
| CTT Threat Feed API Key                            | `CTT_THREAT_FEED_API_KEY`                    | Yes       | Your API Key for accessing Cyber Threat Technology.                                                                                                                                            |
| CTT Threat Feed Base URL                           | `CTT_THREAT_FEED_BASEURL`                    | No        | By default, use https://api.cyberthreattech.ru/v1/. In some cases, you may want to use a local API endpoint                                                                                    |
